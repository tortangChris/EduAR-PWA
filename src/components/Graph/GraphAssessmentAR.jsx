...
const Choice = ({ refCallback, geometry, position, label, selected }) => {
  ...
  useFrame(() => {
    if (meshRef.current) {
      meshRef.current.material.emissive.set(selected ? "green" : "black");
...
export default GraphAssessmentAR;
